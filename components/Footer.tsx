                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2 bg-[#B8E2FF] py-2 px-3 rounded-xl group cursor-pointer hover:shadow-sm transition-all">
                                <div className="w-6 h-6 flex items-center justify-center">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-black group-hover:scale-110 transition-transform">
                                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                                    </svg>
                                </div>
                                <span className="text-black font-semibold text-[13px]">+90 (262) 606 18 65</span>
                            </div>

                            <div className="flex items-center gap-2 bg-[#FFADC1] py-2 px-3 rounded-xl group cursor-pointer hover:shadow-sm transition-all">
                                <div className="w-6 h-6 flex items-center justify-center">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-black group-hover:scale-110 transition-transform">
                                ...
                                <span className="text-black font-semibold text-[13px]">hello@infhouse.co</span>
                            </div>

                            <div className="flex items-center gap-2 bg-[#FFE6A5] py-2 px-3 rounded-xl group cursor-pointer hover:shadow-sm transition-all">
                                <div className="w-6 h-6 flex items-center justify-center">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-black group-hover:scale-110 transition-transform">
                                ...
                                <span className="text-black font-semibold text-[13px]">İstanbul, Türkiye</span>
                            </div>
                        </div>
                    </div>
                </div>
